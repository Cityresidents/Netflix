...
const DEFAULT_OPTIONS = {
  title: '𝗦𝘁𝗿𝗲𝗮𝗺𝗶𝗻𝗴 𝗡𝗲𝘁𝗳𝗹𝗶𝘅  解锁检测',
  fullContent: '完整解锁𝗡𝗲𝘁𝗳𝗹𝗶𝘅 ➠ #REGION_FLAG# #REGION_NAME#',
  fullIcon: 'battery.100',
  fullIconColor: '#808080',
  fullStyle: 'good',
  onlyOriginalContent: '仅支持自制剧 ➠ #REGION_FLAG# #REGION_NAME#',
  onlyOriginalIcon: 'battery.75',
  onlyOriginalIconColor: '#808080',
  onlyOriginalStyle: 'info',
  notAvailableContent: '不支持 𝗡𝗲𝘁𝗳𝗹𝗶𝘅',
  notAvailableIcon: 'battery.50',
  notAvailableIconColor: '#808080',
  notAvailableStyle: 'alert',
  errorContent: '检测失败，请重试',
  errorIcon: 'battery.25',
